var offerModule = angular.module('kmApp.modules.campaign', ['angular.filter', 'kmApp.libraries.notification']);
...
offerModule.controller('kmApp.modules.campaign.redemption', function ($scope) {
